...
if (auctionGrid) {
    auctionGrid.innerHTML = `
        <div class="loading-skeleton" style="grid-column: 1/-1; height: 180px; display: flex; align-items: center; justify-content: center;">
            <div style="text-align:center;">
                <i class="fa-solid fa-spinner fa-spin" style="font-size: 2.5rem; color: var(--accent); margin-bottom: 12px;"></i>
                <p style="color:var(--text-muted); font-size:0.9rem; font-weight:600;">Connecting to Live Auctions...</p>
            </div>
        </div>
    `;
}
